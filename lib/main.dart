...
import 'package:project_android/screens/account_and_security/profile/components/updateMail/update_mail_screen.dart';
    ...
    return MultiProvider(
        ...
        child: MaterialApp(
          ...
          routes: {
            ...
            '/account_and_security/profile/components/updatePhone': (context) =>
                const UpdatePhoneScreen(),
            '/account_and_security/profile/components/updateMail': (context) =>
